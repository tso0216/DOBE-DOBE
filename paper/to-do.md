...
- [ ] **Online 階段拿 test set 當 reference database**（R1-#6）
...
- [ ] **明確定義「typicality ≠ suitability」的假設**（R1-#1、R2-#1）
...
- [ ] **Case study 改定位為「評分機制的示範」而非「驗證」**（R1-#2、R2-#1、R3-#2）
...
- [ ] **新增 Limitations & Future Work 段落**（R1-#7、R2-#3、R3-#2）
