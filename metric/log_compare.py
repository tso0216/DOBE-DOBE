...
# 若只有路徑，預設會使用檔案名稱作為標籤
log1=("model/v2_ddae_moe/result/result_global_router.log",'global')
log2=("model/v2_ddae_moe/result/result.log",'non-global')
log3= ("model/v2_ddae_base/result/result.log","base")
log4=""
log5=""
log6=""
log7=""
