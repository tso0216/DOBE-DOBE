...
N_NEIGHBORS = int(os.environ.get("N_NEIGHBORS", 10))         # 建高維 fuzzy graph 的 kNN 數，跟 data/patch/umap_grid.py 一致
...
LAMBDA_FSCE = float(os.environ.get("LAMBDA_FSCE", 0.25))        # FSCE loss 的權重，warm-up 結束後的最終值
