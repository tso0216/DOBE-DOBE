...
from model.other.v2_deep_ae.cfg import (BATCH, CKPT, EDGE_BATCH, EPOCHS, GRAPH_METRIC, LAMBDA_FSCE,
                 LATENT_DIM, LR, LR_MIN, METRIC, N_NEIGHBORS, OUT, SEED,
                 USE_FSCE, VERSION, WARMUP_EPOCHS, WEIGHT_DECAY, device,
                 open_log)
from model.other.v2_deep_ae.dataset import Patches
    ...
    for epoch in range(EPOCHS):
        try:
            ...
            if (epoch + 1) % 50 == 0 or epoch == 0:
                ...
                log(msg + f"val_{METRIC} {val_metric:.5f}")
