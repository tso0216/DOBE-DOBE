...
"""訓練 v2_residual_ae：基於 v2_ddae_fsce 的架構，引入 ResBlock 與 Residual skip connection。
...
from ae import (ResidualAE, Patches, build_fsce_graph, corrupt,  # noqa: E402
...
def run(data, train_idx, val_idx, edge_i, edge_j, edge_w, a, b, log):
    ...
    model = ResidualAE(LATENT_DIM).to(device)
