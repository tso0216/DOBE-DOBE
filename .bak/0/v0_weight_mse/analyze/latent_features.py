"""用手算特徵表替 v0_weight_mse 的 latent 上色，看 latent 到底編碼了哪個維度。
...
OUT = result("v0_weight_mse", "latent_features.png")
...
def main():
    ...
    fig.suptitle(f"v0_weight_mse latent space 依手算特徵上色（{len(z)} 個 patch）",
                 fontsize=12)
    fig.tight_layout()
