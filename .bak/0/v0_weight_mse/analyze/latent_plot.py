"""畫出 v0_weight_mse 的 latent space，並檢查它到底編碼了什麼。
...
OUT = result("v0_weight_mse", "latent_plot.png")
...
def main():
    ...
    fig.suptitle(f"v0_weight_mse latent space（{len(z)} 個 patch，latent_dim=2，"
