"""畫出 v0_poisson_nll 的 latent space，並檢查它到底編碼了什麼。
...
OUT = result("v0_poisson_nll", "latent_plot.png")
...
def main():
    ...
    fig.suptitle(f"v0_poisson_nll latent space（{len(z)} 個 patch，latent_dim=2，"
