"""畫出 v1_binary 的 latent space，並檢查它到底編碼了什麼。

v1_binary 輸入是 binary presence（0/1），loss = BCE。
...
OUT = result("v1_binary", "latent_plot.png")
...
def main():
    ...
    fig.suptitle(f"v1_binary latent space（{len(z)} 個 patch，"
