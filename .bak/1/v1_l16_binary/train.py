"""訓練 v1_l16_binary 的 in = out ConvAE，輸入為 binary presence，loss = BCE。

與 v1_binary/train.py 的差異：
  - LATENT_DIM = 16（v1_binary 是 32）
  - OUT/CKPT 路徑改為 v1_l16_binary

與 v0_l16/train.py 的差異：
  - render() 回傳 binary float (0/1)，而非 log1p(count)
  - loss 改為 bce_loss，而非 mse_loss
"""
