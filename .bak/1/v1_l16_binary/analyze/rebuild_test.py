"""挑一個 patch 丟進訓練好的 v1_l16_binary AE，比較「進去」與「出來」的 POI 分布。
...
OUT = result("v1_l16_binary", "rebuild_test.png")
...
def main():
    ...
    fig.suptitle(f"patch {n}（latent_dim={LATENT_DIM}，v1_l16_binary）",
                 fontsize=12)
    fig.tight_layout()
