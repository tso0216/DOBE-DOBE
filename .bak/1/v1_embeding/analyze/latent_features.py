"""用手算特徵表替 v1_embeding 的 latent 上色，看 latent 到底編碼了哪個維度。
...
OUT = result("v1_embeding", "latent_features.png")
...
def main():
    ...
    fig.suptitle(f"v1_embeding latent space 依手算特徵上色（{len(z)} 個 patch）",
                 fontsize=12)
    fig.tight_layout()
