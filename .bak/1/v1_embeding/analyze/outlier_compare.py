"""比較 v1_embeding latent space 上的極端離群 patch 與中心（基準）patch。
...
OUT = result("v1_embeding", "outlier_compare.png")
...
def main():
    ...
    fig.suptitle(f"v1_embeding latent space：離群 #{n} vs 基準 patch"
